...
if (!defined('IMAGES_URI')) {
    if(is_ssl()){
        define('IMAGES_URI', 'https:'.get_stylesheet_directory_uri() . '/images/');
    }
    else{
        define('IMAGES_URI', 'http:'.get_stylesheet_directory_uri() . '/images/');
    }
}
...
function register_our_food_menu() {
    register_nav_menu( 'food-menu', __( 'Our Food Menu', 'theme' ) );
}

function register_our_drinks_menu() {
    register_nav_menu( 'drinks-menu', __( 'Our Drinks Menu', 'theme' ) );
}

add_action( 'after_setup_theme', 'theme_register_menus' );
add_action( 'after_setup_theme', 'register_footer_menu' );
add_action( 'after_setup_theme', 'register_our_food_menu' );
add_action( 'after_setup_theme', 'register_our_drinks_menu' );
